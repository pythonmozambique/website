...
home_section.attrs['data-aos'] = 'fade-up'
home_section <= html.H1("Bem-vindo à Comunidade Python Moçambique")
home_section <= html.P(
    "A nossa missão é conectar, educar e inspirar todos os entusiastas de Python em Moçambique.")
...
sobre_section.attrs['data-aos'] = 'fade-up'
...
eventos_section.attrs['data-aos'] = 'fade-up'
...
recursos_section.attrs['data-aos'] = 'fade-up'
...
contacto_section.attrs['data-aos'] = 'fade-up'
